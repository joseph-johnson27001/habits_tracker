    ...
    renderLineChart() {
      if (!this.chart) {
        this.chart = new Chart(this.$refs.lineChart, {
          type: "line",
          data: {
            labels: this.challengeData.labels,
            datasets: [
              {
        ...
        this.chart.data.labels = this.challengeData.labels;
        this.chart.data.datasets[0].data = this.challengeData.data;
